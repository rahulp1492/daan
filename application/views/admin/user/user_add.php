                ...
                <div class="box-content">
                    <form action="<?php echo base_url() . ADMIN_CTRL; ?>/user/add" id="validation-form" class="form-horizontal" method="post">
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group col-sm-6">
                                    <label class="col-sm-4 col-lg-3 control-label" for="email">Email Id<span style="color: red;">*</span></label>
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <input class="form-control show-tooltip" value="<?php echo set_value('email')?>" type="text" name="email" id="email" data-rule-required="true" data-rule-email="true" data-original-title="Add Email Id" data-trigger="hover"/>
                                        <div style="color:red;">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <input class="form-control show-tooltip"  value="<?php echo set_value('phone');?>" type="text" name="phone" id="phone" data-original-title="Add Phone"/>
                                        <div style="color:red;">
                                        ...
                                        <div class="col-sm-8 col-lg-9 controls">
                                            <select class="form-control" data-rule-required="true" data-original-title="Select State" id="state" name="state">
                                                <option value="">Select State</option>
                                                    <option <?php if (set_value('state')=='1') {
                                                        echo "selected";
                                                    }?> value="1">Maharashtra</option>;
                                            </select>
                                            <div style="color:red;">
                                        ...
                                        <div class="col-sm-8 col-lg-9 controls">
                                            <select class="form-control" data-rule-required="true" data-original-title="Select City" id="city" name="city">
                                                <option value="">Select State First</option>
                                                    <option <?php if (set_value('city')=='1') {
                                                        echo "selected";
                                                    }?> value="1">Nashik</option>
                                            </select>
                                            <div style="color:red;">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group col-lg-6 col-sm-6">
                                    <label class="col-sm-4 col-lg-3 control-label" for="address">Address<span style="color: red;">*</span></label>
                                    <div class="col-sm-8 col-lg-9 controls">

                                        <textarea class="form-control show-tooltip"  type="text" name="address" id="address" data-rule-required="true" data-original-title="Add Address" data-trigger="hover"><?php echo set_value('address'); ?></textarea>
                                        <div style="color:red;">
                                ...
                                <div class="form-group col-lg-6 col-sm-6">
                                    <label class="col-sm-4 col-lg-3 control-label" for="pincode">Pin Code<span style="color: red;">*</span></label>
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <input class="form-control show-tooltip" value="<?php echo set_value('pincode'); ?>" type="text" name="pincode" id="pincode" data-rule-required="true" minlength="6" maxlength="6" data-original-title="Add Pin Code" data-trigger="hover" data-rule-number="true"/>
                                        <div style="color:red;">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group col-lg-6 col-sm-6">
                                    ...
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <input class="form-control show-tooltip" type="text" name="aadhar_number" value="<?php echo set_value('aadhar_number') ?>" id="aadhar_number" />
                                        <div style="color:red;">
                                ...
                                <div class="form-group col-lg-6 col-sm-6">
                                    ...
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <input class="form-control show-tooltip" value="<?php echo set_value('tax_id'); ?>" type="text" name="tax_id" id="tax_id" data-rule-required="true"/>
                                        <div style="color:red;">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group col-lg-6 col-sm-6">
                                    ...
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <textarea class="form-control show-tooltip"  type="text" name="other" id="other" data-rule-required="true" data-original-title="Add Address" data-trigger="hover"><?php echo set_value('other'); ?></textarea>
                                        <div style="color:red;">
                                ...
                                <div class="form-group col-lg-6 col-sm-6">
                                    ...
                                    <div class="col-sm-8 col-lg-9 controls">
                                        <input class="form-control show-tooltip" value="<?php echo set_value('profession'); ?>" type="text" name="profession" id="profession" />
                                        <div style="color:red;">
